...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adventure.next_page_number'
        db.add_column('adventure_adventure', 'next_page_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Adventure.next_page_number'
        db.delete_column('adventure_adventure', 'next_page_number')
    ...
    models = {
        'adventure.adventure': {
            ...
            'next_page_number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
