...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rating'
        db.create_table('adventure_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('adventure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adventure.Adventure'])),
            ('rating', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('adventure', ['Rating'])

        # Adding unique constraint on 'Rating', fields ['adventure', 'user']
        db.create_unique('adventure_rating', ['adventure_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Rating', fields ['adventure', 'user']
        db.delete_unique('adventure_rating', ['adventure_id', 'user_id'])
        ...
        db.delete_table('adventure_rating')
