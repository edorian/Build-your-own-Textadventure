...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('adventure_location', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.number'
        db.delete_column('adventure_location', 'number')
