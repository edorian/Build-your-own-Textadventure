...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field links on 'Location'
        db.create_table('adventure_location_links', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_location', models.ForeignKey(orm['adventure.location'], null=False)),
            ('to_location', models.ForeignKey(orm['adventure.location'], null=False))
        ))
        db.create_unique('adventure_location_links', ['from_location_id', 'to_location_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field links on 'Location'
        db.delete_table('adventure_location_links')
