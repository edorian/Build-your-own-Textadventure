...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Graph'
        db.create_table('adventure_graph', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('adventure', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['adventure.Adventure'], unique=True)),
            ('hash', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('dot', self.gf('django.db.models.fields.TextField')()),
            ('svg', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal('adventure', ['Graph'])


    def backwards(self, orm):
        
        # Deleting model 'Graph'
        db.delete_table('adventure_graph')
