...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adventure.modified'
        db.add_column('adventure_adventure', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Location.created'
        db.add_column('adventure_location', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Location.modified'
        db.add_column('adventure_location', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Adventure.modified'
        db.delete_column('adventure_adventure', 'modified')

        # Deleting field 'Location.created'
        db.delete_column('adventure_location', 'created')

        # Deleting field 'Location.modified'
        db.delete_column('adventure_location', 'modified')
