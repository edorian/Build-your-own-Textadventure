...
urlpatterns = patterns('',
    ...
    url(r'^adventure/list/my/$', "website.adventure.views.player.adventure_list_my", name="adventure-list-my"),
    url(r'^adventure/detail/(?P<object_id>\d+)/$', "website.adventure.views.player.adventure_detail", name="adventure-detail"),
    url(r'^adventure/start/(?P<object_id>\d+)/$', "website.adventure.views.player.adventure_start", name="adventure-start"),
    ...
    url(r'^adventure/(?P<object_id>\d+)/edit/$',
        ...
        name='adventure-edit'),
    url(r'^adventure/(?P<adventure_id>\d+)/location/list/$',
        'website.adventure.views.editor.location_list',
        name='location-list'),
